...
<div>
  <h4 className="font-bold sm:text-[32px] text-[32px] sm:leading-[40px] leading-[36px] text-white ">
    Samantha
  </h4>
  <p
...
>“With the development of today's technology, metaverse is very useful for today's work, or can be called web 3.0. by using metaverse you can use it as anything”</p>
    ...
    className="relative flex-1 flex justiy-center items-center ml-10 none-ml"
    >
<img src="/planet-09.png" alt="planet-09" className="w-[100%] lg:h-[600px] h-auto min-h-[210px] object-cover rounded-[40px]" />
<motion.div
